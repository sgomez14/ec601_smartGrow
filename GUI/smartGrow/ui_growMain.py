...
class Ui_smartGrowGUI(object):
    ...
    def retranslateUi(self, smartGrowGUI):
        ...
        self.feedScheduleLabel_1.setText(QCoreApplication.translate("smartGrowGUI", u"Feed Schedule (every x seconds)", None))
        ...
        self.hoursOnLabel_1.setText(QCoreApplication.translate("smartGrowGUI", u"Seconds On", None))
        self.hoursOffLabel_1.setText(QCoreApplication.translate("smartGrowGUI", u"Seconds Off", None))
        ...
        self.feedScheduleLabel_20.setText(QCoreApplication.translate("smartGrowGUI", u"Feed Schedule (every x seconds)", None))
        ...
        self.hoursOnLabel_20.setText(QCoreApplication.translate("smartGrowGUI", u"Seconds On", None))
        self.hoursOffLabel_20.setText(QCoreApplication.translate("smartGrowGUI", u"Seconds Off", None))
        ...
        self.feedScheduleLabel_30.setText(QCoreApplication.translate("smartGrowGUI", u"Feed Schedule (every x seconds)", None))
        ...
        self.hoursOnLabel_30.setText(QCoreApplication.translate("smartGrowGUI", u"Seconds On", None))
        self.hoursOffLabel_30.setText(QCoreApplication.translate("smartGrowGUI", u"Seconds Off", None))
